...
```bash
git clone https://github.com/eternal2026-cloud/calidad_productividad.git
cd calidad_productividad
```
...
3. **Configurar credenciales de Google Sheets**
   ...
   e. Crear el archivo `.streamlit/secrets.toml` o en Streamlit Cloud Secrets con:
...
[google_sheets]
data_maestra_url = "https://docs.google.com/spreadsheets/d/1JKpDvbwMIW4ec4A5HX0fk4KSfrh3eD1JBz48KoAjzM0/edit"
calidad_url = "https://docs.google.com/spreadsheets/d/1GsshQ093VaoixVAlbUTfYP5DaIltcqtoI5upkHoXXdg/edit"
```
...
1. **Data_Maestra_Limpia**: Datos de productividad
   - URL: [Tu hoja de datos maestros](https://docs.google.com/spreadsheets/d/1JKpDvbwMIW4ec4A5HX0fk4KSfrh3eD1JBz48KoAjzM0/edit)

2. **Calidad**: Datos de control de calidad
   - URL: [Tu hoja de calidad](https://docs.google.com/spreadsheets/d/1GsshQ093VaoixVAlbUTfYP5DaIltcqtoI5upkHoXXdg/edit)
